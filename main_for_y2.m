...
[x1_train,x2_train,y_train] = generateDatasetY2(round(0.70*N));
[x1_test,x2_test,y_test] = generateDatasetY2(round(0.30*N));


figure('Name','Train Data For Y2');
...
figure('Name','Test Predict For Y2');
